...
class TestDisplayElement(unittest.TestCase):
    ...
    def test_creation_minimal(self):
        ...
        elem = DisplayElement(mode=1, mode_sub=0, x=100, y=50, main_count=0, sub_count=1)
    ...
    def test_mode_name_property(self):
        ...
        for mode, expected_name in test_cases:
            ...
            self.assertEqual(
                elem.mode_name, expected_name, f"mode={mode} should be '{expected_name}'"
            )

    def test_color_hex_property(self):
        """Test color_hex property."""
        elem = DisplayElement(
            mode=1, mode_sub=0, x=0, y=0, main_count=0, sub_count=0, color_argb=(255, 255, 128, 64)
        )
    ...
    def test_color_hex_black(self):
        ...
        elem = DisplayElement(
            mode=1, mode_sub=0, x=0, y=0, main_count=0, sub_count=0, color_argb=(255, 0, 0, 0)
        )
    ...
    def test_color_hex_white(self):
        ...
        elem = DisplayElement(
            mode=1, mode_sub=0, x=0, y=0, main_count=0, sub_count=0, color_argb=(255, 255, 255, 255)
        )
...
class TestParseDdFormat(unittest.TestCase):
    ...
    def _build_dd_file(
        self, element_count: int, elements: list = None, system_info: bool = True
    ) -> bytes:
...
class TestDcToOverlayConfig(unittest.TestCase):
    ...
    def test_hardware_element_with_temp_unit(self):
        ...
        dc_config = {
            ...
            "display_elements": [
                DisplayElement(
                    mode=0,
                    mode_sub=1,  # Fahrenheit
                    x=200,
                    y=150,
                    main_count=0,
                    sub_count=1,  # CPU temp
                    font_size=24.0,
                    font_style=1,
                    color_argb=(255, 255, 128, 64),
                )
    ...
    def test_multiple_time_elements(self):
        ...
        dc_config = {
            "elements": {},
            "display_elements": [
                DisplayElement(mode=1, mode_sub=0, x=100, y=50, main_count=0, sub_count=0),
                DisplayElement(mode=1, mode_sub=1, x=100, y=100, main_count=0, sub_count=0),
            ],
            "flags": {},
        }
        result = dc_to_overlay_config(dc_config)
    ...
    def test_legacy_cpu_temp_element(self):
        ...
        dc_config = {
            "elements": {"cpu_temp": ElementConfig(x=50, y=100, font=font, enabled=True)},
            "display_elements": [],
            "flags": {"cpu_temp": True},
        }
        result = dc_to_overlay_config(dc_config)
...
class TestParseDisplayElements(unittest.TestCase):
    ...
    def test_single_valid_element(self):
        ...
        elem_data = self._build_element_bytes(
            mode=1, x=50, y=100, font_name="Arial", font_size=24.0, r=255, g=128, b=64, text=""
        )
...
class TestDcToOverlayEdge(unittest.TestCase):
    ...
    def test_display_element_custom(self):
        ...
        dc = {
            ...
            "display_elements": [
                DisplayElement(
                    mode=4, mode_sub=0, x=10, y=20, main_count=0, sub_count=0, text="Custom!"
                ),
            ],
        }
        result = dc_to_overlay_config(dc)
    ...
    def test_display_element_hardware(self):
        ...
        dc = {
            ...
            "flags": {},
            "display_elements": [
                DisplayElement(mode=0, mode_sub=0, x=10, y=20, main_count=1, sub_count=2),
            ],
        }
        result = dc_to_overlay_config(dc)
    ...
    def test_font_style_regular(self):
        ...
        dc = {
            ...
            "display_elements": [
                DisplayElement(
                    mode=1, mode_sub=0, x=10, y=20, main_count=0, sub_count=0, font_style=0
                ),
            ],
        }
        result = dc_to_overlay_config(dc)
