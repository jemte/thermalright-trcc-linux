...
class TestRoundTrip(unittest.TestCase):
    ...
    def test_roundtrip_elements(self):
        ...
        config = ThemeConfig(elements=elems, rotation=90, mask_enabled=True, mask_x=10, mask_y=20)
...
class TestSaveThemeMask(unittest.TestCase):
    ...
    def test_mask_image_only(self):
        with tempfile.TemporaryDirectory() as d:
            ...
            save_theme(
                d, bg, mask_image=mask, mask_position=None, display_width=320, display_height=320
            )
...
class TestWriteConfigJson(unittest.TestCase):
    ...
    def test_writes_valid_json(self):
        ...
        with tempfile.TemporaryDirectory() as d:
            overlay = {
                "time": {"x": 10, "y": 20, "color": "#ff0000", "metric": "time", "enabled": True}
            }
