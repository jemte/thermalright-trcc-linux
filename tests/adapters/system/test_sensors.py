...
from trcc.adapters.system.sensors import (
    _HWMON_DIVISORS,
    _HWMON_TYPES,
    SensorEnumerator,
    SensorInfo,
...
class TestSensorEnumeratorDiscover(unittest.TestCase):
    ...
    @patch('trcc.adapters.system.sensors.NVML_AVAILABLE', False)
    @patch('trcc.adapters.system.sensors.Path')
...
class TestSensorEnumeratorReadRapl(unittest.TestCase):
    ...
    @patch('trcc.adapters.infra.data_repository.SysUtils.read_sysfs')
    @patch('trcc.adapters.system.sensors.time')
...
class TestSensorEnumeratorReadPsutil(unittest.TestCase):
    ...
    @patch('trcc.adapters.system.sensors.psutil')
...
class TestMapDefaults(unittest.TestCase):
    ...
    def test_returns_dict(self):
        ...
        from trcc.adapters.system.sensors import map_defaults
...
class TestDiscoverNvidia(unittest.TestCase):
    ...
    @patch('trcc.adapters.system.sensors.NVML_AVAILABLE', True)
    @patch('trcc.adapters.system.sensors.pynvml')
...
class TestNvmlImport(unittest.TestCase):
    ...
    def test_nvml_available_flag_exists(self):
        ...
        from trcc.adapters.system.sensors import NVML_AVAILABLE
