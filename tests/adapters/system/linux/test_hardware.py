...
class TestGetMemoryInfo:
    ...
    @patch(
        "trcc.adapters.system.linux.hardware._privileged_cmd",
    ...
    def test_dmidecode_nonzero_returncode_falls_back(
        self, mock_cmd: MagicMock, mock_run: MagicMock
    ) -> None:
    ...
    def test_subprocess_exception_returns_empty(
        self, mock_cmd: MagicMock, mock_run: MagicMock
    ) -> None:
    ...
    def test_fields_not_in_dmi_fields_ignored(
        self, mock_cmd: MagicMock, mock_run: MagicMock
    ) -> None:
...
class TestGetDiskInfo:
    ...
    @patch("trcc.adapters.system.linux.hardware._get_smart_health")
    @patch("trcc.adapters.system.linux.hardware.subprocess.run")
    def test_partitions_and_loops_filtered(
...
class TestGetSmartHealth:
    ...
    def test_health_line_without_passed_or_failed(
        self, mock_cmd: MagicMock, mock_run: MagicMock
    ) -> None:
...
class TestModuleConstants:
    ...
    def test_polkit_policy_path(self) -> None:
        assert _POLKIT_POLICY == "/usr/share/polkit-1/actions/com.github.jemte.trcc.policy"
