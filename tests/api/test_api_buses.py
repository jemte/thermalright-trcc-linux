...
class TestDisplayAPIBus:
    ...
    def test_set_brightness_calls_device(self, mock_lcd, client):
        mock_lcd.set_brightness.return_value = {"success": True, "message": "ok"}
    ...
    def test_set_rotation_calls_device(self, mock_lcd, client):
        mock_lcd.set_rotation.return_value = {"success": True, "message": "ok"}
    ...
    def test_set_split_calls_device(self, mock_lcd, client):
        mock_lcd.set_split_mode.return_value = {"success": True, "message": "ok"}
...
class TestLEDAPIBus:
    ...
    def test_set_brightness_calls_device(self, mock_led, client):
        mock_led.set_brightness.return_value = {"success": True, "message": "ok"}
    ...
    def test_set_sensor_calls_device(self, mock_led, client):
        mock_led.set_sensor_source.return_value = {"success": True, "message": "ok"}
    ...
    def test_set_zone_color_calls_device(self, mock_led, client):
        mock_led.set_zone_color.return_value = {"success": True, "message": "ok"}
